...
import backend.academy.log_analizer.statisticCollector.collector.MedianSizeCollector;
import org.junit.jupiter.api.Test;
import java.util.ArrayList;
import java.util.List;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class MedianSizeCollectorTest {
    ...
    void collector(){
        ...
        MedianSizeCollector collector =
            new MedianSizeCollector("avgRespCollector");
        ...
        assertEquals(327, Integer.parseInt(collector.finisher().apply(o)));
