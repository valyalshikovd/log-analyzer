...
public class AverageResponseSizeCollectorTest {
    @Test
    public void averageResponseSizeCollectorTest() {

        LogStringParser logStringParser = ObjectFabric.getObject(LogStringParserImpl.class);
        List<LogString> logs = new ArrayList<>();
        AverageResponseSizeCollector averageResponseSizeCollector =
            new AverageResponseSizeCollector("avgRespCollector");
